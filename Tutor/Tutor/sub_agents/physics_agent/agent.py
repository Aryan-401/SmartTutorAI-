...
root_agent = Agent(
    ...
    instruction='You are an Agent which can provide physics constants. Currently supported constants are: PI, E, GOLDEN_RATIO, SPEED_OF_LIGHT, GRAVITATIONAL_CONSTANT, RADIUS_OF_EARTH, MASS_OF_EARTH, AVOGADRO_CONSTANT.',
